...
@click.away="isDialogOpen = false">
    ...
    <div class="pl-3 flex flex-col">
        ...
        <a href="{{ route('buyer.wishlist') }}"
           class="transition-all hover:font-bold hover:text-indigo-500 px-4 py-3 border-l-2 border-indigo-500-lighter hover:border-indigo-500  font-hk  border-indigo-500 font-bold text-indigo-500">Wishlist</a>
