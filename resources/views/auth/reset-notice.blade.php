...
<div class="min-h-screen flex  justify-center py-12 px-4 sm:px-6 lg:px-8 -mt-10">
    <div class="max-w-md w-full space-y-8">
        ...
        {{ __('Want to Reset Password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to set a new one.') }}
        </div>
        @error('email')
