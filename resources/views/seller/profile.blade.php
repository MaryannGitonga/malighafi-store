    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <a href="{{ route('seller.activate-buyer') }}" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:ml-3 sm:w-auto sm:text-sm">
            Switch
          </a>
       ...
       <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
        ...
        <div class="lg:w-3/4 mt-12 lg:mt-0">
            ...
            <div class="bg-grey-light py-10 px-6 sm:px-10 mb-6 rounded-lg">
                ...
                @method('PUT')
                    <div class="mb-12">
                        <img src="{{ $user->profile_photo_path != null ? asset($user->profile_photo_path) : asset('images/avatar.png') }}"
