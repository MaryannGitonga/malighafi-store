...
class VendorController extends Controller
{
    ...
    public function products()
    {
        ...
        return view('vendor.products', compact('string'));
    }
    ...
    public function check_permit(Request $request)
    {
        if ($request->user()->permit_no == null) {
            return view('vendor.permit-upload')->with('info', 'Please upload you permit and fill in the rest of the fields before proceeding. You can only operate once this is done.');
        }
